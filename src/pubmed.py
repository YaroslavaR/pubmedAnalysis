...
from util import create_keywords_excel
...
if __name__ == '__main__':
    ...
    logging.info('Searching for ' + SEARCH_TERM_1 + ' with max_returned=' + str(MAX_RETURNED_TERM_1))
    ...
    logging.info('Searching for ' + SEARCH_TERM_2 + ' with max_returned=' + str(MAX_RETURNED_TERM_2))
    ...
    create_avg_citations_age_per_year_plot(ai_age_of_cited_work, ml_age_of_cited_work)
