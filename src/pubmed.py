...
if __name__ == '__main__':
    ...
    ml_papers_map, ml_articles_links_map, ml_citations_map = create_maps(SEARCH_TERM_1 + ' NOT '+ SEARCH_TERM_2, MAX_RETURNED_TERM_1)
    ...
    ai_papers_map, ai_articles_links_map, ai_citations_map = create_maps(SEARCH_TERM_2 + ' NOT '+ SEARCH_TERM_1, MAX_RETURNED_TERM_2)
    ...
    create_amount_of_article_citations_per_year_plot(ai_map, ml_map, cit_ai_dict_sort, cit_ml_dict_sort)
    create_avg_citations_age_per_year_plot(cit_ai_dict_sort, cit_ml_dict_sort, ai_age_of_cited_work, ml_age_of_cited_work)
